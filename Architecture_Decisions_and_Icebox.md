...
### 🧊 MVP и игровая статистика (мотивация игроков)
Лёгкий **MVP / post-game** слой: кто сколько урона нанёс, криты, хил — как **мотиватор для игроков** и материал для ретроспективы сессии (локально, без облака). Связка с логом боя и опциональными колонками.
