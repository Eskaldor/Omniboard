...
> Обновлено: 03.05.2026 (**ADR-25** — результат броска в toast / `rollToast.tsx`; **ADR-24** — терминал бросков GM Console; ADR-12 уточнение `logic.py`; ADR-22 — переход слота из `led_triggers`)
