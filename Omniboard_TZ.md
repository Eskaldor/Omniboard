...
> Обновлено: 21.04.2026 (+ `CombatSession` / домены, Asset Override JSON-merge, API layouts & miniatures)
...
│   │   └── config/             # ADR-4: базовые JSON-конфиги (layouts, bars, LED) — «неприкосновенный фундамент»
