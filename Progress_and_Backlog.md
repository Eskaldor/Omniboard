...
### **Текущая фаза: Фаза 11 — Движки Систем (Modular Engines)**
- [ ] Создать базовые классы движков (`backend/engines/`) для Инициативы, Урона, Пулов.
- [ ] Добавить тип поля `checkbox_group` в `columns.json` (Action/Bonus/Reaction).
- [ ] Плагин `logic.py` внутри систем для специфичных правил (сброс реакций).
...
**Активные задачи (текущий спринт):** *Фаза 11 — Движки Систем* — три пункта в разделе «План на следующий спринт» выше.
