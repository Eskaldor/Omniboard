...
- **Шаблоны мини-листа** (`sheet_profiles`): группировка характеристик и макросов на карточке персонажа; у актёра можно задать свою группировку действий и свои макросы (см. `Omniboard_TZ.md` §2.1.3)
