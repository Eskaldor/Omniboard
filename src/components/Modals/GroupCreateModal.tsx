...
export function GroupCreateModal({ isOpen, onClose, onSubmit }: GroupCreateModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    const trimmedName = name.trim() || t('modals.default_new_group_name');
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          <div>
            ...
            <input
              ...
              placeholder={t('modals.group_name_placeholder')}
          ...
          <div>
            ...
            <div className="flex flex-wrap items-center gap-3">
              <input
                ...
                title={t('modals.custom_color')}
              />
              <div className="flex flex-wrap gap-2">
                {PRESET_COLORS.map((preset) => {
                  const label = t(`modals.preset_color_${preset.key}`);
                  return (
                  <button
                    key={preset.hex}
                    type="button"
